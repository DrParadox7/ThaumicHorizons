...
@Mod(
        ...
        dependencies = "required-after:Forge@[10.13.2,);" +
                       "required-after:Thaumcraft@[4.2.3.4,)",
...
public class ThaumicHorizons {
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        if(enablePocket) {
            ...
            ConfigResearch.recipes.put("PlanarGateway", Arrays.asList(new Object[]{(new AspectList()).add(Aspect.AIR, 250).add(Aspect.FIRE, 250).add(Aspect.WATER, 250).add(Aspect.EARTH, 250).add(Aspect.ENTROPY, 250).add(Aspect.ORDER, 250), Integer.valueOf(5), Integer.valueOf(5), Integer.valueOf(1), Arrays.asList(new Object[]{new ItemStack(ConfigBlocks.blockMetalDevice, 1, 3), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(blockSlot), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(ConfigBlocks.blockMetalDevice, 1, 3), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), infusion13, infusion13, infusion13, new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), infusion13, infusion13, infusion13, new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), infusion13, infusion13, infusion13, new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(ConfigBlocks.blockMetalDevice, 1, 3), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11), new ItemStack(ConfigBlocks.blockMetalDevice, 1, 3)})}));
        ...
        dummyStack1.setTagCompound(dummyTag1);
        dummyInputStack1 = new ItemStack(itemDummy, 1, 15);
        ResearchPage warpedTumor2 = new ResearchPage(new InfusionRecipe("warpedTumor", dummyStack1, 12, (new AspectList()).add(Aspect.TAINT, 64).add(Aspect.ELDRITCH, 48).add(Aspect.TRAP, 32).add(Aspect.FLESH, 24).add(Aspect.EXCHANGE, 16), dummyInputStack1, new ItemStack[]{new ItemStack(ConfigBlocks.blockTaint, 1, 2), new ItemStack(ConfigItems.itemSanitySoap, 1, 0), new ItemStack(Items.nether_star, 1, 0), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 0), new ItemStack(Items.nether_star, 1, 0), new ItemStack(ConfigItems.itemBathSalts, 1, 0)}));
        ...
        selfRecipes.add(new SelfInfusionRecipe("warpedTumor", 12, (new AspectList()).add(Aspect.TAINT, 64).add(Aspect.ELDRITCH, 48).add(Aspect.TRAP, 32).add(Aspect.FLESH, 24).add(Aspect.EXCHANGE, 16), new ItemStack[]{new ItemStack(ConfigBlocks.blockTaint, 1, 2), new ItemStack(ConfigItems.itemBathSalts, 1, 0), new ItemStack(Items.nether_star, 1, 0), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 0), new ItemStack(Items.nether_star, 1, 0), new ItemStack(ConfigItems.itemSanitySoap, 1, 0)}, 8));
